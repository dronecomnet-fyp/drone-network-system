package lk.rescuemesh.emergency_app
 ...
 * cellular, where 10.42.0.1 has no route, so the checkin upload and the
 * SOS silently fail even though the phone is sitting on RESCUE_A.
 *
