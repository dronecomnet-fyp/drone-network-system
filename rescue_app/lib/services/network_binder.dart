/// NetworkBinder: force this app's traffic onto Wi-Fi (file 05, bench
/// finding 2026-07-14).
///
...
/// 10.42.0.1 has no route, and the app reports a bare socket failure while
/// the phone is sitting on RESCUE_A. Binding the process to the Wi-Fi
/// network fixes it, so nobody has to know to switch mobile data off.
///
